...
export function Connectteacher({ onBack }: WritingPracticeProps) {
    const navigate = useNavigate();   // <-- add this

const [currentView, setCurrentView] = useState<WritingView>("levels");
const levels = [
{
id: "connect to class teacher",
title: "connect to class teacher",
description: "Connect and learn from your class teacher",
color: "from-[#3B82F6] to-[#00B9FC]",
},

{
id: "Connect to foreign language teacher",
title: "Connect to foreign language teacher",
...
// <h2 className="text-3xl mb-4">Coming Soon!</h2>
// <p className="text-white/80">Intermediate writing exercises are being prepared for you.</p>
// </div>
// </div>
// </div>
// );
...
// Back to Levels
// </Button>
// <h1 className="text-xl text-white">Advanced Writing</h1>
// <div className="w-32" />
// </div>
// </div>
// </header>
...
// <Sparkles className="w-16 h-16 mx-auto mb-4 animate-pulse" />
// <h2 className="text-3xl mb-4">Coming Soon!</h2>
// <p className="text-white/80">Advanced writing exercises are being prepared for you.</p>
// </div>
// </div>
// </div>
// );
